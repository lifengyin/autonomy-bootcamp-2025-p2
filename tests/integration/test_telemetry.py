...
def read_queue(
    ...
    while not controller.is_exit_requested():
        try:
            telemetry_data = output_queue.queue.get(timeout=TELEMETRY_PERIOD + NUM_FAILS)
...
def main() -> int:
    ...
    # Create your queues
    output_queue = queue_proxy_wrapper.QueueProxyWrapper(mp_manager, OUTPUT_QUEUE_MAXSIZE)
